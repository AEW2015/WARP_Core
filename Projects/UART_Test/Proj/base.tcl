...
# module references:
# LED_Control, RGB_Control, Top_Control, UART_RX, UART_TX, btn_control, btn_debounce, btn_debounce, btn_debounce, btn_debounce, btn_split
...
CONFIG.FREQ_HZ {100000000} \
  ...
  # Create port connections
  connect_bd_net -net CLK100MHZ_1 [get_bd_ports CLK100MHZ] [get_bd_pins LED_Control_0/clk] [get_bd_pins RGB_Control_0/CLK] [get_bd_pins Top_Control_0/clk] [get_bd_pins UART_RX_0/clk] [get_bd_pins UART_TX_0/clk] [get_bd_pins buttons/CLK100MHZ]
  ...
  connect_bd_net -net RST_N_1 [get_bd_ports rst_n] [get_bd_pins LED_Control_0/rst_n] [get_bd_pins RGB_Control_0/RST_N] [get_bd_pins Top_Control_0/rst_n] [get_bd_pins UART_RX_0/rst_n] [get_bd_pins UART_TX_0/rst_n] [get_bd_pins buttons/rst_n]
